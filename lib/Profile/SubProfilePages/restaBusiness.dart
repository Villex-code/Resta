  ...
  Widget build(BuildContext context) {
    final solutions = [
      ...
      },
      {
        ...
        'title': 'Digital Menu',
        'text': 'Customizable Digital Menus',
    ...
    final useCases = [
      ...
      {
        'imagePath': 'assets/profile/business/beach2.jpeg',
        'title': 'Beach Bars',
        'text': 'Revolunionize Your Beach Services',
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(children: [
                  ...
                  "Check out how you can integrated OnSpot to increase sales and customer satisfaction while reducing labor costs."
                      .text
                      .center
                      .makeCentered(),
                ]),
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return InkWell(
          onTap: () => launchUrl(Uri.parse(routelink)),
          child: ClipRRect(
            borderRadius:
